<template>
  <div>
    <div class="row HomeLayer" v-if="this.hasContent">
      <div class="col-xl-8 col-md-8 col-sm-12">
        <div class="row dlfex-center">
      ...
      <div class="col-xl-2 col-md-2 col-sm-12 col-xs-12 about-deck-layer">
        <about-deck :deck="this.deck"/>
        <br>
        <button type="button" class="btn btn-danger btn-lg btn-new-dec" @click="newDeck()">Generate New Deck</button>
      </div>
    </div>
